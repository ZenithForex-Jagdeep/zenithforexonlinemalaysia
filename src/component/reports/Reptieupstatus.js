...
function Reptieuptatus() {
    ...
    useEffect(() => {
        if (onceRun) {
            ...
            Common.callApi(Common.apiAddEditRight, ["getright", "REPTIEUPSTATUS", sid], (result) => {
