...
function Repnextfollowup() {
    ...
    const [repFromDate, setRepFromDate] = useState(new Date("04/01/2023"));
    ...
    useEffect(() => {
        if (sid === null) {
            ...
            Common.callApi(Common.apiAddEditRight, ["getright", "REPNEXTFOLLOWUP", sid], (result) => {
    ...
    return (
        <>
            ...
            <div className="p-3">
                <Row className='my-2'>
                    <Col><h3>Follow Up.</h3></Col>
                </Row>
                <Row>
                    <Col className='divHide'>
                        <Form.Group>
...
export default Repnextfollowup
