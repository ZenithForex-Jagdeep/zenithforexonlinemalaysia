...
function Cashfreereturncorpmodule() {
    ...
    useEffect(() => {
        const obj = {
            ...
            ordertype: "corp_module"
        }
        Common.callApi(Common.apiCashfree, [sid, "corp_module", JSON.stringify(obj)], (result) => {
...
export default Cashfreereturncorpmodule;
