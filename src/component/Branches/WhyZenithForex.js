...
const content = {
    HYDERABAD: {
        title: "Why Zenith Global  Stands Out in Hyderabad",
        data: [
            {
                icon: "💹",
            ...
            },
            {
                ...
                description: "Zenith Global  is fully licensed and operates under RBI regulations. Every <strong>money exchange in Hyderabad </strong> is secure, documented, and legally compliant, giving you complete peace of mind.",
            },
            {
                icon: "🚚",
                title: "City-Wide Coverage",
                description: "From Banjara Hills to Gachibowli, Hitech City to Jubilee Hills, we provide fast delivery of foreign currency across Hyderabad. No matter where you are, Zenith Global  brings currency to your doorstep or preferred pickup point.",
            },
            {
                icon: "💻",
            ...
            },
            {
                ...
                description: "From popular currencies like USD, GBP, and EUR to AED, SGD, CAD, and JPY, Zenith Global  covers a broad spectrum to meet the diverse needs of Hyderabad’s travelers.",
            },
            {
                icon: "🔒",
    ...
    BENGALURU: {
        title: "Why Choose Zenith Global  for Currency Exchange in Bangalore?",
        data: [
            {
                icon: "📊",
                title: "Best Live & Transparent Rates",
                description: "Say goodbye to confusing rates and hidden margins. Zenith Global  updates currency rates in real time, ensuring you always get the <strong>most competitive value for your money</strong>. What you see on our website is exactly what you pay—no surprises, no hidden charges.",
            },
            {
                icon: "🛡️",
                title: "RBI-Authorized & Secure Transactions",
                description: "Your trust is our priority. Zenith Global  operates under the authorization and compliance framework of the Reserve Bank of India (RBI). Every transaction — whether it’s buying or selling foreign currency — follows official RBI guidelines. That means your forex dealings are completely <strong>safe, legal, and traceable. </strong>",
            },
            {
                icon: "🚚",
            ...
            },
            {
                ...
                description: "From USD, EUR, GBP, and AED to AUD, SGD, CAD, and more — <strong>Zenith Global </strong> offers an extensive selection of global currencies. Whether you’re traveling to the USA, the UK, the Middle East, or Europe, we have your currency ready and available.",
            },
            {
                icon: "🔒",
    ...
    KOLKATA: {
        title: "Why Use Zenith Global  for Money Exchange in Kolkata?",
        data: [
            {
                icon: "💹",
            ...
            },
            {
                ...
                description: "hether it’s US Dollar, Euro, Pound, Dirham, or other popular currencies, Zenith Global  handles them all. We also assist with converting back leftover foreign currencies into INR.",
            },
            {
                icon: "🔒",
    ...
    NOIDA: {
        title: "Why Zenith Global  is the Best Choice for Currency Exchange in Noida",
        data:
            [
                {
                    icon: "📊",
                    title: "Real-Time Rates with No Hidden Fees",
                    description: "At Zenith Global , the <strong>currency exchange in Noida </strong> process is completely transparent. You get to see <strong>live market rates </strong> on our website, updated every few seconds. No middlemen. No hidden margins. Just honest rates and clear billing.",
                },
                {
                    icon: "🛡️",
                    title: "RBI-Authorized Money Exchange",
                    description: "Every transaction made through Zenith Global  follows RBI regulations. So, when you choose us for<strong> money exchange in Noida</strong>, you’re not just getting the best deal — you’re choosing a 100% safe and authorized platform that you can rely on.",
                },
                {
                    icon: "🚚",
                    title: "Doorstep Delivery Across Noida",
                    description: "Need foreign currency urgently? We deliver it straight to your home or office anywhere in Noida — whether you’re in Sector 18, Sector 62, Greater Noida, or Noida Extension. That’s how convenient <strong>currency exchange in Noida</strong> can be with Zenith Global .",
                },
                {
                    icon: "📱",
                    title: "Easy Online Booking Process",
                    description: "Forget complex paperwork. With Zenith Global , <strong>money exchange in Noida</strong> is now just a few clicks away. Choose your currency, upload your documents, make the payment, and relax — we’ll take care of the rest.",
                },
                {
                    icon: "💸",
    ...
    DELHI: {
        title: "The Zenith Global Advantage",
        data: [
            {
                icon: "💹",
                title: "Competitive Rates You Can Count On",
                description: "Delhi is full of options, but very few give you real-time currency rates without hidden markups. At Zenith Global , we believe you deserve clarity. The rate you see is the rate you get — no commission surprises, no confusing jargon, just clean, fair pricing every time.",
            },
            {
                icon: "🛡️",
                title: "RBI-Authorized & Fully Secure",
                description: "Zenith Global  operates under full RBI authorization. Every transaction is carried out in line with India’s foreign exchange regulations, ensuring that your money exchange in Delhi is 100% safe, compliant, and traceable",
            },
            {
                icon: "🚚",
            ...
            },
            {
                ...
                description: "Need US Dollars for a trip to New York? Euros for your study in Germany? Dirhams for your Dubai getaway? We’ve got you covered. Zenith Global  offers 25+ currencies to buy or sell, with quick availability across Delhi NCR.",
            },
        ]
    },
};
