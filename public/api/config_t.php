...
if ( $cashfreeLive ) {
    //live
    define( 'A_CASHFREE_RETURN_URL', 'https://www.zenithglobal.com.my/cf/{order_id}' );
    // live
    define( 'A_CASHFREE_NOTIFY_URL', 'https://www.zenithglobal.com.my/api/notify.php' );
    // live
    ...
    //test
    define( 'A_CASHFREE_RETURN_URL', 'http://localhost:8005/cf/{order_id}' );
    // test
    define( 'A_CASHFREE_NOTIFY_URL', 'http://localhost:8005/api/notify_a.php' );
    // test
