...
class Career
 {
    ...
    public function insertCareerLead( $dbio, $obj ) {
        ...
        if ( $result ) {
            ...
            $ml = $ml . "Job Application from zenithglobal.com.my/career <br>
                    ...
                    Profile: " . $row[ 2 ] . " <br>
                    Resume: <a href='https://www.zenithglobal.com.my/upload/" . $row[ 1 ] . "' download>Download</a> <br>
    ...
    public function viewDocument( $dbio, $request ) {
        ...
        if ( $doc_ext == 'jpg' ) {
            ...
            $typ = 'text/plain';
            // Corrected MIME type for plain text files
